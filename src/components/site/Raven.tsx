    ...
    >
      <defs>
        <linearGradient id="raven-body" x1="20%" y1="0%" x2="95%" y2="100%">
          <stop offset="0%" stopColor="oklch(0.36 0.012 265)" />
          <stop offset="55%" stopColor="oklch(0.22 0.008 265)" />
          <stop offset="100%" stopColor="oklch(0.13 0.004 265)" />
        </linearGradient>
      ...
      <g className={animated ? "raven-tilt" : undefined}>
        ...
        <path
          ...
          fill={traced ? "none" : "oklch(0.3 0.01 265)"}
          stroke={traced ? "currentColor" : "url(#raven-rim)"}
        ...
        <path
          ...
          stroke={traced ? "currentColor" : "oklch(0.42 0.012 265)"}
          strokeWidth="2"
          strokeLinecap="round"
          className={traced ? "raven-trace" : undefined}
        />
        ...
        <path
          ...
          fill={traced ? "none" : "oklch(0.11 0.004 265)"}
        ...
        <path
          ...
          stroke={traced ? "currentColor" : "oklch(0.4 0.01 265)"}
          strokeWidth="1.1"
          strokeOpacity="0.7"
          strokeLinecap="round"
        />
        ...
        <path
          ...
          fill={traced ? "none" : "oklch(0.19 0.006 265)"}
          stroke={traced ? "currentColor" : "url(#raven-rim)"}
          strokeWidth={traced ? 2 : 1.2}
          strokeLinejoin="round"
          className={traced ? "raven-trace" : undefined}
        />
        {/* perch */}
        <path d="M84 178l-4 24M96 184l2 20" stroke={traced ? "currentColor" : "oklch(0.45 0.05 45)"} strokeWidth="2.4" strokeLinecap="round" />
